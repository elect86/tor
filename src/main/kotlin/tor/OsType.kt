...
enum class OsType { WIN, LNX32, LNX64, MACOS, ANDROID;
    ...
    companion object {
        ...
        private fun getLinuxType(): OsType {
            ...
            try {
                ...
                if (exit != 0) throw  RuntimeException("Uname returned error code $exit")

                if (unameOutput.matches(Regex("i.86"))) return LNX32

                if (unameOutput.compareTo("x86_64") == 0) return LNX64
    ...
    val isUnixoid get() = listOf(LNX32, LNX64, MACOS).contains(this)
}
